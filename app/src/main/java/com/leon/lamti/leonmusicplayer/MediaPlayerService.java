...
/**
 * Created by Timoleon on 2/3/2017.
 */
...
public class MediaPlayerService extends Service implements MediaPlayer.OnCompletionListener,
  ...
  //List of available Audio files
    private ArrayList<SongObject> audioList;
    private int audioIndex = -1;
    private SongObject activeAudio; //an object of the currently playing audio
    ...
    public void onDestroy() {
        ...
        Log.d("PLAY_AUDIO", "Destroy Service - mediaPlayer: " + mediaPlayer);
    ...
    private void initMediaSession() throws RemoteException {
        ...
        mediaSession.setCallback(new MediaSessionCompat.Callback() {
            ...
            public void onStop() {
                ...
                //removeAudioFocus();
                Log.d("PLAY_AUDIO", "On Stop - mediaPlayer: " + mediaPlayer);
    ...
    private void buildNotification(PlaybackStatus playbackStatus) {
        ...
        Bitmap largeIcon = BitmapFactory.decodeResource(getResources(),
                R.drawable.ic_music); //replace with your own image
